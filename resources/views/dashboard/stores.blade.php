                                    ...
                                    <td class="d-flex justify-content-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-dark">
                                                <li><a class="dropdown-item active" href="{{ route('storespublic.main',['store'=>$store->subdomain]) }}" target="_blank">إستعراض</a></li>
                                                <li><a class="dropdown-item" href="{{ route('dashboard.stores.viewer',['id'=>$store->id]) }}" target="_self">تعديل</a></li>
                                                <li><a class="dropdown-item" href="{{ route('dashboard.stores.design',['id'=>$store->id]) }}" target="_self">تصميم</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
