    ...
    <div class="container-fluid vh-100 p-0 m-0" style="background-color: transparent;"> 
        <div class="row h-100 p-0 m-0">
            <div class="col-md-4 col-lg-3 col-xl-2 d-none d-md-block h-100 translate-1s p-2">
                <div class="shadow-lg bg-white h-100 rounded p-3 pe-2 ps-2">
                    <div class="d-flex align-items-center mt-2">
                        ...
                        <div class="me-2">
                            <div class="fs-6 fw-bold">@yield('store_name')</div>
                            <div class="text-muted" style="font-size:15px">@yield('user_name')</div>
                        </div>
                        
                    </div>
                    <div class="d-flex justify-content-center  pt-0 pb-0">
                        <ul class="pt-4 p-0 w-100 m-0" style="list-style:'none'">
                            <li class="w-100 mt-2 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard') text-warning @else bg-white @endif" link="{{ route('stores.dashboard',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
                                <i class="material-icons ms-2">home</i>
                                <span>الرئيسية</span>
                            </li>
                            <li class="w-100 mt-3 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard.categories') text-warning @else bg-white @endif" link="{{ route('stores.dashboard.categories',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
                                <i class="material-icons ms-2">list</i>
                                <span>التصنيفات</span>
                            </li>
                            <li class="w-100 mt-3 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard.products') text-warning @else bg-white @endif" link="{{ route('stores.dashboard.products',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
                                <i class="material-icons ms-2">shopping_basket</i>
                                <span>المنتجات</span>
                            </li>
                            <li class="w-100 mt-3 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard.files') text-warning @else bg-white @endif" link="{{ route('stores.dashboard.files',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
                                <i class="material-icons ms-2">folder</i>
                                <span>إدارة الملفات</span>
                            </li>
                            <li class="w-100 mt-3 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard.design') text-warning @else bg-white @endif" link="{{ route('stores.dashboard.design',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
                                <i class="material-icons ms-2">view_sidebar</i>
                                <span>التصميم</span>
                            </li>
                            <li class="w-100 mt-3 p-3 pt-2 pb-2 fs-6 fw-bold d-flex hand @if(Route::currentRouteName() == 'stores.dashboard.subscriptions') text-warning @else bg-white @endif" link="{{ route('stores.dashboard.subscriptions',['store'=>request()->route('store')]) }}" onclick="openTab(this)">
            ...
            <div class="col-md-8 col-lg-9 col-xl-10 h-100 translate-1 p-0">
                <div class="w-100"  style="">
                    <div class="row m-0 p-3 ps-2 pe-2 p-md-2 bg-sm-white mf-navbar rounded-bottom" style="z-index:1" id="navbar">
                        <div class="col-6 col-md-2 d-flex align-items-center order-1">
                            ...
                            <span class="fw-bold d-md-none">@yield('store_name')</span>
                        </div>
                ...
                <div class="w-100 overflow-auto store-height scrolly p-2 ps-3 pe-3 mt-2" id="contents">
                @section('body')
                @show
                </div>
            </div>
