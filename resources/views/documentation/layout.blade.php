    ...
    <div class="container-fluid vh-100">
        <div class="row h-100">
            <div class="col-md-4 col-lg-3 col-xl-2 d-none d-md-block shadow-lg bg-light h-100 translate-1s pe-0 ps-0">
                <div class="d-flex justify-content-center align-items-center text-dark fw-bold  fs-5" style="height:60px">Documentation</div>
                <div class="d-flex justify-content-center p-2 pt-0 pb-0">
                    <ul class="mt-5 p-0 w-100 m-0" style="list-style:'none'">
                        @role(['documentation'])
                            <li class="bg-white w-100 rounded mt-3 p-2 fs-6 fw-bold d-flex hand shadow-sm" link="{{ route('documentation.auth') }}" onclick="openTab(this)">Auth</li> 
                            <li class="bg-white w-100 rounded mt-3 p-2 fs-6 fw-bold d-flex hand shadow-sm" link="{{ route('documentation.users') }}" onclick="openTab(this)">Users</li> 
                        @endcanany
                    </ul>
                </div>
            </div>
